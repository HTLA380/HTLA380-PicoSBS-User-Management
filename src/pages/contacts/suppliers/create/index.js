      ...
      <>
        <div className="px-8 bg-white rounded-xl">
          ...
          <div className="py-4">
            ...
            <div className="grid grid-cols-8 mt-5 gap-x-10 gap-y-5">
              <div className="col-span-2">
              ...
              <>
                <div className="grid grid-cols-8 gap-10 mt-5">
                  ...
                  <div className="col-span-2">
                    <Input
                      type="number"
                      className="overflow-hidden rounded-lg focus:outline-none focus:border-none"
                ...
                <div className="w-full mt-10 mb-5 border-t border-gray-500"></div>
                <div className="grid grid-cols-8 mt-5 gap-x-10 gap-y-5">
                  <div className="col-span-2">
                    <Input
